...
This guide documents the organization-level configuration for the agentic coding workflow. These are one-time setup steps that enable all repositories in your organization to use Claude Code with GitHub Actions, Jira, and Slack integration.
...
**Location:** github.com/your-org → Settings → Secrets and variables → Actions
...
| `JIRA_SERVER` | Jira instance URL | `https://your-org.atlassian.net` |
...
1. Go to github.com/your-org → Settings → GitHub Apps
...
1. Create a new Atlassian account for the service (e.g., `claude-automation@your-company.com`)
...
- Verify the secret exists at org level: github.com/your-org → Settings → Secrets
...
1. Check Claude GitHub App is installed: github.com/your-org → Settings → GitHub Apps
...
| Resource | URL |
|----------|-----|
| GitHub org settings | github.com/your-org/settings |
| GitHub org secrets | github.com/organizations/your-org/settings/secrets/actions |
