---
name: implement-all
description: Automatically work through all Jira stories in the backlog, analyzing dependencies and implementing in optimal order.
argument-hint: <JIRA-PROJECT-KEY> [--wait|--batch]
