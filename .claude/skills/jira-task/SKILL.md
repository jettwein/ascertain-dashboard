---
name: jira-task
description: Fetch a Jira issue and prepare an implementation plan. Use when the user wants to understand a ticket before implementing.
...
### Applicable ADRs
[List any accepted ADRs from ~/.claude/adr/ and docs/adr/ that constrain this implementation, with relevant MUST rules]
