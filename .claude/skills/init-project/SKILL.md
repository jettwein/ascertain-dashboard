---
name: init-project
description: Read a requirements document and create a project plan with Jira user stories. Generates stories.md for review before creating Jira tickets.
argument-hint: <JIRA-PROJECT-KEY> [requirements-file]
